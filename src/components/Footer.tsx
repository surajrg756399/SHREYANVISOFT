        ...
        <div className="flex flex-col items-center text-center relative">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="font-black text-2xl tracking-[0.2em] text-white flex items-center gap-2">
              SHREYANVISOFT 
              <span className="text-[10px] align-top bg-slate-800 px-1.5 py-0.5 rounded border border-slate-700">TM</span>
            </span>
          </div>
          ...
          <p className="text-sm text-slate-400 font-medium mb-8 flex items-center gap-2">
            ...
            Email: <a href="mailto:sales@shreyanvisoft.com" className="text-blue-400 hover:text-blue-300 transition-colors">sales@shreyanvisoft.com</a>
          </p>
          ...
          <p className="text-[10px] text-slate-500 font-bold tracking-[0.2em] uppercase">&copy; {new Date().getFullYear()} Shreyanvisoft. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
